...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST")
    {
        ...
        $query = "INSERT INTO `modification_log` (`id`, `category`, `part_name`, `part_number`, `price`, `mileage`, `date`, `comment`, `image_filename`, `vehicle_id`) VALUES ('', '', '$part_name', '$part_no', '$price', '$mileage', '$date', '$comment', '', '$vehicle_id')";

        mysqli_query($con, $query);

        header("Location: ../pages/modifications.php");
        die;
    }
?>
